...
typedef enum {
    DLPF_BAND_WIDTH_250HZ = 0,
    DLPF_BAND_WIDTH_184HZ,
    DLPF_BAND_WIDTH_92HZ,
    DLPF_BAND_WIDTH_41HZ,
    DLPF_BAND_WIDTH_20HZ,
    DLPF_BAND_WIDTH_10HZ,
    DLPF_BAND_WIDTH_5HZ
}MPU6500_DLPFBandWidth_e;

typedef enum {
    SAMPLE_RATE_DIVIDER_1000HZ = 0,
    SAMPLE_RATE_DIVIDER_500HZ,
    SAMPLE_RATE_DIVIDER_333HZ,
    SAMPLE_RATE_DIVIDER_250HZ,
    SAMPLE_RATE_DIVIDER_200HZ,
    SAMPLE_RATE_DIVIDER_167HZ,
    SAMPLE_RATE_DIVIDER_143HZ,
    SAMPLE_RATE_DIVIDER_125HZ,
 ...
 *
 *  @retval -> MPU6500_Device_t construct.
 */
